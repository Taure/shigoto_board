    ...
    [
        #{
            ...
            routes => [
                ...
                {"/dlq", fun shigoto_board_page_controller:dlq/1, #{methods => [get]}},
                ...
                {"/dlq/redrive-all", fun shigoto_board_action_controller:redrive_all/1, #{
                    methods => [post]
                }},
                {"/dlq/:id/redrive", fun shigoto_board_action_controller:redrive/1, #{
                    methods => [post]
                }},
