...
worker_row(W) ->
    iolist_to_binary([
        <<"<tr>">>,
        <<"<td class=\"mono\">">>,
        maps:get(worker, W, <<"unknown">>),
        <<"</td>">>,
        <<"<td>">>,
        i2b(maps:get(total, W, 0)),
        <<"</td>">>,
        <<"<td>">>,
        i2b(maps:get(available, W, 0)),
        <<"</td>">>,
        <<"<td>">>,
        i2b(maps:get(executing, W, 0)),
        <<"</td>">>,
        <<"<td>">>,
        i2b(maps:get(completed, W, 0)),
        <<"</td>">>,
        <<"<td>">>,
        i2b(maps:get(retryable, W, 0)),
        <<"</td>">>,
        <<"<td>">>,
        i2b(maps:get(discarded, W, 0)),
        <<"</td>">>,
        <<"</tr>">>
    ]).
